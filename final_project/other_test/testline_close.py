...
if __name__ == "__main__":
    # 設定圖像文件路徑
    image_pathx = './input/sobelx.jpg'  # 確保此文件存在於指定路徑
    image_pathy = './input/sobely.jpg'
    ...
    # 儲存閉運算後的圖像（可選）
    cv2.imwrite('./result/sobelx_closed.jpg', closedx_normalized)
    cv2.imwrite('./result/sobely_closed.jpg', closedy_normalized)
